...
import 'package:dexter_task/widgets/gradients_generator/core/flutter_gradients_type.dart';
import 'package:dexter_task/widgets/gradients_generator/core/flutter_sweep_gradients.dart';
import 'package:flutter/widgets.dart';

import 'core/flutter_gradients_names.dart';
import 'core/flutter_linear_gradients.dart';
import 'core/flutter_radial_gradients.dart';
...
class FlutterGradients {
  ...
  static Gradient findByName(FlutterGradientNames name,
          ...
          double endAngle = math.pi * 2,
          TileMode tileMode = TileMode.repeated}) =>
      _find(names[name.index], type: type, center: center, radius: radius, startAngle: startAngle, endAngle: endAngle, tileMode: tileMode);
  ...
  static Gradient _find(String name,
    ...
    switch (name) {
      case "Warm Flame":
        return warmFlame(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Night Fade":
        return nightFade(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Spring Warmth":
        return springWarmth(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);
      case "Juicy Peach":
        return juicyPeach(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Young Passion":
        return youngPassion(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Lady Lips":
        return ladyLips(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sunny Morning":
        return sunnyMorning(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Rainy Ashville":
        return rainyAshville(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Frozen Dreams":
        return frozenDreams(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Winter Neva":
        return winterNeva(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Dusty Grass":
        return dustyGrass(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Tempting Azure":
        return temptingAzure(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Heavy Rain":
        return heavyRain(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Amy Crisp":
        return amyCrisp(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Mean Fruit":
        return meanFruit(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Deep Blue":
        return deepBlue2(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Ripe Malinka":
        return ripeMalinka(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Cloudy Knoxville":
        return cloudyKnoxville(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Malibu Beach":
        return malibuBeach(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "New Life":
        return newLife(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "True Sunset":
        return trueSunset(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Morpheus Den":
        return morpheusDen(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Rare Wind":
        return rareWind(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Near Moon":
        return nearMoon(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Wild Apple":
        return wildApple(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Saint Petersburg":
        return saintPetersburg(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Plum Plate":
        return plumPlate(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Everlasting Sky":
        return everlastingSky(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Happy Fisher":
        return happyFisher(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Blessing":
        return blessing(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sharpeye Eagle":
        return sharpeyeEagle(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Ladoga Bottom":
        return ladogaBottom(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Lemon Gate":
        return lemonGate(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Itmeo Branding":
        return itmeoBranding(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Zeus Miracle":
        return zeusMiracle(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Old Hat":
        return oldHat(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Star Wine":
        return starWine(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Happy Acid":
        return happyAcid(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Awesome Pine":
        return awesomePine(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "New York":
        return newYork(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Shy Rainbow":
        return shyRainbow(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Mixed Hopes":
        return mixedHopes(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Fly High":
        return flyHigh(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Strong Bliss":
        return strongBliss(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Fresh Milk":
        return freshMilk(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Snow Again":
        return snowAgain(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "February Ink":
        return februaryInk(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Kind Steel":
        return kindSteel(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Soft Grass":
        return softGrass(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Grown Early":
        return grownEarly(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sharp Blues":
        return sharpBlues(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Shady Water":
        return shadyWater(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Dirty Beauty":
        return dirtyBeauty(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Great Whale":
        return greatWhale(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Teen Notebook":
        return teenNotebook(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Polite Rumors":
        return politeRumors(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sweet Period":
        return sweetPeriod(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Wide Matrix":
        return wideMatrix(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Soft Cherish":
        return softCherish(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Red Salvation":
        return redSalvation(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Burning Spring":
        return burningSpring(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Night Party":
        return nightParty(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sky Glider":
        return skyGlider(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Heaven Peach":
        return heavenPeach(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Purple Division":
        return purpleDivision(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Aqua Splash":
        return aquaSplash(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Spiky Naga":
        return spikyNaga(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Love Kiss":
        return loveKiss(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Clean Mirror":
        return cleanMirror(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Premium Dark":
        return premiumDark(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Cold Evening":
        return coldEvening(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Cochiti Lake":
        return cochitiLake(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Summer Games":
        return summerGames(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Passionate Bed":
        return passionateBed(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Mountain Rock":
        return mountainRock(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Desert Hump":
        return desertHump(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Jungle Day":
        return jungleDay(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Phoenix Start":
        return phoenixStart(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "October Silence":
        return octoberSilence(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Faraway River":
        return farawayRiver(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Alchemist Lab":
        return alchemistLab(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Over Sun":
        return overSun(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Premium White":
        return premiumWhite(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Mars Party":
        return marsParty(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Eternal Constance":
        return eternalConstance(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Japan Blush":
        return japanBlush(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Smiling Rain":
        return smilingRain(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Cloudy Apple":
        return cloudyApple(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Big Mango":
        return bigMango(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Healthy Water":
        return healthyWater(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Amour Amour":
        return amourAmour(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Risky Concrete":
        return riskyConcrete(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Strong Stick":
        return strongStick(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Vicious Stance":
        return viciousStance(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Palo Alto":
        return paloAlto(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Happy Memories":
        return happyMemories(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Midnight Bloom":
        return midnightBloom(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Crystalline":
        return crystalline(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Party Bliss":
        return partyBliss(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Confident Cloud":
        return confidentCloud(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Le Cocktail":
        return leCocktail(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "River City":
        return riverCity(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Frozen Berry":
        return frozenBerry(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Child Care":
        return childCare(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Flying Lemon":
        return flyingLemon(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "New Retrowave":
        return newRetrowave(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Hidden Jaguar":
        return hiddenJaguar(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Above The Sky":
        return aboveTheSky(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Nega":
        return nega(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Dense Water":
        return denseWater(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Seashore":
        return seashore(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Marble Wall":
        return marbleWall(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Cheerful Caramel":
        return cheerfulCaramel(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Night Sky":
        return nightSky(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Magic Lake":
        return magicLake(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Young Grass":
        return youngGrass(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Colorful Peach":
        return colorfulPeach(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Gentle Care":
        return gentleCare(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Plum Bath":
        return plumBath(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Happy Unicorn":
        return happyUnicorn(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "African Field":
        return africanField(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Solid Stone":
        return solidStone(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Orange Juice":
        return orangeJuice(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Glass Water":
        return glassWater(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "North Miracle":
        return northMiracle(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Fruit Blend":
        return fruitBlend(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Millennium Pine":
        return millenniumPine(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "High Flight":
        return highFlight(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Mole Hall":
        return moleHall(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Space Shift":
        return spaceShift(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Forest Inei":
        return forestInei(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Royal Garden":
        return royalGarden(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Rich Metal":
        return richMetal(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Juicy Cake":
        return juicyCake(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Smart Indigo":
        return smartIndigo(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sand Strike":
        return sandStrike(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Norse Beauty":
        return norseBeauty(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Aqua Guidance":
        return aquaGuidance(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sun Veggie":
        return sunVeggie(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sea Lord":
        return seaLord(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Black Sea":
        return blackSea(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Grass Shampoo":
        return grassShampoo(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Landing Aircraft":
        return landingAircraft(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Witch Dance":
        return witchDance(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sleepless Night":
        return sleeplessNight(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Angel Care":
        return angelCare(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Crystal River":
        return crystalRiver(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Soft Lipstick":
        return softLipstick(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Salt Mountain":
        return saltMountain(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Perfect White":
        return perfectWhite(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Fresh Oasis":
        return freshOasis(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Strict November":
        return strictNovember(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Morning Salad":
        return morningSalad(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Deep Relief":
        return deepRelief(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sea Strike":
        return seaStrike(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Night Call":
        return nightCall(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Supreme Sky":
        return supremeSky(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Light Blue":
        return lightBlue(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Mind Crawl":
        return mindCrawl(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Lily Meadow":
        return lilyMeadow(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sugar Lollipop":
        return sugarLollipop(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Sweet Dessert":
        return sweetDessert(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Magic Ray":
        return magicRay(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Teen Party":
        return teenParty(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Frozen Heat":
        return frozenHeat(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Gagarin View":
        return gagarinView(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Fabled Sunset":
        return fabledSunset(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);

      case "Perfect Blue":
        return perfectBlue(type: type, endAngle: endAngle, startAngle: startAngle, center: center, radius: radius, tileMode: tileMode);
